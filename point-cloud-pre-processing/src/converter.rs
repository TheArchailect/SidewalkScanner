...
impl PointCloudConverter {
    ...
    fn log_file_info(&self) -> Result<(), Box<dyn std::error::Error>> {
        ...
        for vlr in header.vlrs() {
            if vlr.record_id == 4 {
                ...
                // Parse correctly: field name starts at byte 4, data type at byte 2
                if vlr.data.len() >= 17 {
    ...
    fn generate_textures(
        ...
        for (point_idx, point_result) in reader.points().enumerate() {
            ...
            // insert into the spatial strucutre
        ...
        // Generate flood-fill heightmap from all collected points
    ...
    fn generate_flood_fill_heightmap(
        ...
        heightmap_gen.generate_flood_fill_from_road_points(road_points)?;
        Ok(())
    }
    ...
    fn save_metadata(
        ...
        let metadata = serde_json::json!({
            ...
            "textures": {
                "position": "RGBA32F - XYZ coordinates + connectivity class id",
